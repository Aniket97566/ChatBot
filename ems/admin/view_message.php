...
if(isset($_REQUEST['m_reply'])){
	...
	$res=mysqli_query($conn,$query);
	if($res){
	echo "Reply Inserted successfully!<br>";
	}
	else echo "Error in reply,please try again";
}
?>
...
<div class="form-group row">
      <label for="inputEmail" class="col-lg-2 control-label"><h3>Write Your Reply:<br></h3></label><br>
      <div class="col-lg-10">
<textarea name="m_reply" rows="5" style="width:100%;background:#d9d9d9;padding:6px;"></textarea>
</div></div>
...
<p>&nbsp;</p>
<div class="form-group row">
      <label for="inputEmail" class="col-lg-2 control-label"><h3> Your Reply:<br></h3></label><br>
      <div class="col-lg-10">
	  <?php $m_id=$_GET['id'];
